...
const services = [
...

  {
    ...
    alt: "Child's haircut",
    description:
      "Gentle, age-appropriate haircut designed for comfort and style.",
    price: 25,
    popular: true,
    details: [
  ...
  },
  {
    ...
    image: "assets/images/feature-4.jpeg",
    alt: "Military style haircut",
    description: "A precise, clean cut with a classic military look.",
    price: 20,
    popular: false,
    details: [
...
const openServiceModal = (service) => {
    ...
    const selectedService = services.find((item) => item.id === Number(service.id));
...
const setupScrollShiftCards = () => {
  ...
  const updateCardTrack = () => {
    ...
    currentX -= scrollDelta * 0.5; // Adjust scroll speed here
